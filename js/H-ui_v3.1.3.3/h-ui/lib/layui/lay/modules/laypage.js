...
;layui.define(function (e) {
    ...
    u.prototype.type = function () {
        ...
        var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1, i = {
            prev: function () {
                return a.prev ? '<a href="javascript:;" style="padding: 0 5px;border-radius:4px " class="layui-laypage-prev' + (1 == a.curr ? " " + r : "") + '" ' +
                    'data-page="' + (a.curr - 1) + '">'
                    // + a.prev
            ...
            next: function () {
                return a.next ? '<a href="javascript:;" style="padding: 0 5px;border-radius:4px " class="layui-laypage-next' + (a.curr == a.pages ? " " + r : "") + '"' +
                    ' data-page="' + (a.curr + 1) + '">'
                    //+ a.next
                    +"<i class='layui-icon'>&#xe602;</i>"
                    + "</a>" : ""
            }(),
            count: '<span class="layui-laypage-count">总共 ' + a.count + " 条</span>",
            limit: function () {
            ...
            skip: function () {
                return ['<span class="layui-laypage-skip">&#x8DF3;&#x81F3;', '<input type="text" min="1" value="' + a.curr + '" class="layui-input">', '&#x9875;<button type="button" class="layui-laypage-btn">&#x786e;&#x5b9a;</button>', "</span>"].join("")
            }()
        };
